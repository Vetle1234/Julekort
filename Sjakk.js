...
canvas.addEventListener("click", (event) => {
    ...
    if (valgtBrikke!=null) {
        ...
        if(trekk>1){
            ...
            console.log("trekk", trekk-1,": hvit", valgtBrikke.type, "til", koordinatKolonne+koordinatRad )
            }
            else{
            ...
            if(trekk>1){
                ...
                console.log("trekk", trekk-1,": svart", valgtBrikke.type, "til", koordinatKolonne+koordinatRad )
                }
                else{
